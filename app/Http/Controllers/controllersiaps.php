...
/*FUNCIONES PARA RECIBIR PETICIONES*/
  ...
  function acceptMessage(){
      ...
      ini_set('default_socket_timeout', 120);
       ...
       $array = array('token'=>$token,'Mensaje'=>$respuesta->mensaje,'MD5'=>$respuesta->md5);
       $json_array = json_encode($array);
       $array_param = array('json_array' => $json_array);
       try {
           $soapClient = new Soapclient($url.'?wsdl', $soapParameters);
  ...
  function responder(){
      $jsonRespuesta="";
      $jsonRespuesta =   $this->obtenerRespuestas()->generarRespuestasResult;
      //var_dump(json_decode($jsonRespuesta));
